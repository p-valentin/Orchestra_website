const STEPS = [
  {
    ...
    body: 'Pick from 43 instruments — navigate, click, extract, loop, branch. Point at any element in the embedded browser to grab its selector. No code, no boilerplate.',
  },
  {
    n: '02',
